        ...
        Column(
            ...
            ExposedDropdownMenuBox(
                ...
                TextField(
                    ...
                    onValueChange = { },
                    label = { Text(stringResource(R.string.picture_select_resolution)) },
                    trailingIcon = {
            ...
            Box(
                ...
                if (imageBitmap != null) {
                    ...
                    Text(
                        stringResource(R.string.picture_empty_hint),
            ...
            Button(
                ...
                Text(stringResource(R.string.picture_set_params))
            }
            Button(
                ...
                Text(stringResource(R.string.picture_take_photo))
            }
        }
    }
}
