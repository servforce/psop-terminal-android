...
class CustomProtocolActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CXRMSamplesTheme {
                CustomProtocolScreen(viewModel)
            }
        }
...
fun CustomProtocolScreen(viewModel: CustomProtocolViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Text(
                text = stringResource(R.string.custom_protocol_title),
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Text(
                text = stringResource(R.string.custom_protocol_received_label),
        ...
        Button(
            ...
            Text(stringResource(R.string.custom_protocol_send_button))
        }
    }
}
